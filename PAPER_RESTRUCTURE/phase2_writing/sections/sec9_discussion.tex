...
The standard evidence that this mechanism improves detection is artifactual---attributable to sparse-graph self-scoring, granularity, and unmatched computation, and reproduced in full by configuration models without community structure.
