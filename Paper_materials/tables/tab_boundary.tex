...
(starred, bold): email-Enron (robust across all tested configurations) and com-Youtube (small gain confined to mild calibrated retention; see text). Genuine gains therefore exist, but they are rare and
small ($\le 0.009$).}
\label{tab:boundary}
\footnotesize
