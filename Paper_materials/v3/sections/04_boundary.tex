...
baseline seed spread by factors of $8.0$ to $14.4$ at every degree at or above
$49$. On the objective it is not: the same cells clear it by factors between
$1.0$ and $5.8$, and at the mildest retention several cells at $51$, $201$ and
$261$ are negative in the worst case. The recovery result survives a hostile
reading of the seeds; the modularity result survives only at the aggressive
operating points.
...
their degree coefficient of variation spans an order of magnitude, from $0.14$ to
$1.47$, and across sixty generator-by-degree cells the gain correlates with
...
what sits on the far side of it. Below average degree $11$ there is nothing: 90
cells across five networks, seven sparsifiers, two ways of choosing $k$, and not
...
benchmark graphs while holding the planted labels fixed confirms it for
similarity-based selection: recovery gain rises monotonically with the injected
fraction in every one of the four configurations tested, and at average degree
...
accelerates: the median end-to-end speedup falls from $0.75\times$ at average
degree $10$ to $0.26\times$ at $200$. The original speedups were obtained with an
...
planted structure is barely detectable and baseline recovery sits between $0.06$
and $0.14$, no gain appears at any degree: across 104 configurations L-Spar
