...
Two are the methods whose quality claims motivate the pipeline: local
sparsification, L-Spar~\cite{satuluri2011local}, and the degree-based sampler
DSpar~\cite{liu2023dspar}, one from each family described in
Section~\ref{sec:background}. L-Spar and the method NetworKit calls Local
Similarity are distinct and both appear below; L-Spar always refers to the method
of Satuluri et al. Three more are the methods that the largest
