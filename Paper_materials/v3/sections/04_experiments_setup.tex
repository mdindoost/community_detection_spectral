...
extending to 25 million edges, listed in
Section~\ref{sec:experiments:mechanism}.
...
every network. Graclus~\cite{dhillon2007weighted} and
MLR-MCL~\cite{satuluri2009scalable} are not. Both are distributed by their
authors and both build and run on a current toolchain, so their absence from this
study is a limitation of the study and not of the available software. Graclus is
the more consequential of the two, because it takes the number of communities as
an input and is one of the two algorithms for which the original report's
ground-truth gains were consistent, which places it inside the condition this
paper identifies rather than outside it.
Section~\ref{sec:discussion} returns to both.

\paragraph{Operating points}
Sparsifiers are compared at matched realized retention, with targets of $0.5$ and
$0.2$. Six of the seven methods cannot reach the lower target on the three
sparsest networks and four cannot on the fourth,
...
\toprule
Network & $d_{\mathrm{avg}}$ & Backb. & L-Spar & L.\ Deg. & L.\ Sim. &
K-Neigh.\\
\midrule
com-Amazon    &  5.53 & 0.362 & 0.301 & 0.352 & 0.298 & 0.330\\
ca-HepTh      &  5.74 & 0.348 & 0.276 & 0.347 & 0.273 & 0.317\\
com-DBLP      &  6.62 & 0.302 & 0.244 & 0.301 & 0.234 & 0.277\\
ca-CondMat    &  8.55 & 0.234 & 0.186 & 0.234 & 0.177 & 0.218\\
email-Enron   & 10.73 & 0.186 & 0.159 & 0.186 & 0.155 & 0.179\\
wiki-Vote     & 28.51 & 0.070 & 0.067 & 0.070 & 0.067 & 0.069\\
email-Eu-core & 32.58 & 0.061 & 0.053 & 0.061 & 0.053 & 0.060\\
\bottomrule
\end{tabular}
\end{table}
