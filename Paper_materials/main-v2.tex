...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/cit-HepTh_figure_A_modularity_no_alpha1.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/plot1_delta_vs_mu.pdf}
